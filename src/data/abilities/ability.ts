...
export function initAbilities() {
  (allAbilities as Ability[]).push(
    ...
    new AbBuilder(AbilityId.STALL, 4)
      .attr(ChangeMovePriorityInBracketAbAttr, (_pokemon, _move: Move) => true, MovePriorityInBracket.LAST_IN_BRACKET)
      .build(),
    ...
    new AbBuilder(AbilityId.MYCELIUM_MIGHT, 9)
      .attr(ChangeMovePriorityInBracketAbAttr, (_pokemon, move) => move.category === MoveCategory.STATUS, MovePriorityInBracket.LAST_IN_BRACKET)
