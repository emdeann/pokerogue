...
export class DropDownOption extends Label {
  ...
  constructor(key: string | number, labels: DropDownLabel | DropDownLabel[], type: DropDownType) {
...
export class DropDown extends Phaser.GameObjects.Container {
  ...
  constructor(
    ...
    const window = addWindow(
      ...
      0,
      50,
      this.optionButtons.y + options[this.shownOptions - 1].y + this.optionHeight + this.optionPaddingY,
      false,
      false,
      undefined,
      undefined,
